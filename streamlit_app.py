...
genai.configure(api_key="AIzaSyDWo6EpmUnOS3isXJmGEEmrLt-XLqCp9nI")
...
st.set_page_config(page_title="Ashi's Invoice Generator")
st.sidebar.header('RoboBill')
st.sidebar.write('Made by Ashi Jha')
st.sidebar.write('Powered by google gemini ai')
st.header('RoboBill')
st.subheader('Made by Ashi Jha')
st.subheader('Manage your expenses here in one click !')
...
input_prompt="""
You are an expert in reading invoices. We are going to upload an image of an invoice and you will have to answer any
